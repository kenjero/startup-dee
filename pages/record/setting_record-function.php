...
if ($_POST['method'] == "fileGoogleDrive") {
  ...
  try {
    ...
    $cardBody = '<p><small class="form-text text-muted"> Google Drive : <a class="pc-link" href="'.$url.'" target="_blank">'.$url.'</a></small></p>';

    if ($files == null) {

      $cardBody .=  '<div class="alert alert-dark text-center" role="alert">No data available in google drive</div>';
